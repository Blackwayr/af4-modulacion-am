...
Materia: Señales y Sistemas (A) — Término 2026-2
...
1. `01_senal_mensaje_portadora.png` — Señal mensaje y portadora en el tiempo.
2. `02_senal_modulada_tiempo.png` — Señal modulada AM y su envolvente.
3. `03_espectro_senal_modulada.png` — Espectro de frecuencia de la señal modulada.
4. `04_escenarios_ruido_distorsion.png` — Señal recibida en los tres escenarios simulados.
5. `05_comparacion_espectral.png` — Comparación espectral: señal limpia vs. señal degradada.
